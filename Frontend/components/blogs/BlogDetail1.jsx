...
export default function BlogDetail1({ blog: propBlog }) {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      if (propBlog) return; // If blog is passed as prop, don't fetch
  ...
  return (
    ...
    <div className="blog-detail-wrap">
                <div className="image">
                  <div className="bg-gray-200 animate-pulse" style={{ width: '100%', height: 400 }}></div>
                </div>
      <div className="inner">
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-8 mb-lg-30">
            ...
            <div className="meta justify-content-center mb-4">
              <div className="meta-item gap-8">
                <div className="icon">
                  <i className="icon-calendar" />
                </div>
            ...
            <div className="blog-content">
              ...
              <div className="heading mb-4">
                <ul className="list-tags has-bg justify-content-center mb-3">
                  <li>
                ...
                {/* Blog Title */}
                <h3 className="fw-5 text-center mb-4">{blog.title}</h3>
        </div>
