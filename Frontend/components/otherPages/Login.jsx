...
//               <div className="password-actions" style={{ 
//                 display: "flex", 
      ...
      <div className="container">
        <div className="login-wrap">
          <div className="left">
            ...
            <form onSubmit={handleSubmit} className="form-login" suppressHydrationWarning>
              <div className="wrap">
                <fieldset>
                  <input
                    className={errors.email ? "error" : ""}
              ...
              <div className="button-submit text-center" style={{ marginTop: "40px" }}>
                <button
                  type="submit"
                  className="tf-btn btn-fill w-100"
                  disabled={isSubmitting}
                  suppressHydrationWarning
                >
                  <span className="text text-button">{isSubmitting ? "Logging in..." : "Login"}</span>
                </button>
              </div>
            </form>
          </div>
